...
var toolConfig = [
  ...
  },
  {
    ...
    "detail": "女性偶像、平面偶像及女演員登場的雜誌，以及相關寫真集的資訊。\n\n・[アイドル雑誌情報Z / X](https://x.com/idolzj)",
    "tags": [
      "公式",
      "photo"
    ],
  ...
  },
  {
    ...
    "detail": "桌面端SHOWROOM串流播放器。內置留言、錄製功能。",
    "tags": [
      "公式",
      "tool",
      "streaming"
  ...
  },
  {
    ...
    "detail": "・無限制實時廣播收聽\n・[存檔回放功能](https://record.nogi46.me/table) record.nogi46.me",
    "tags": [
      "公式",
      "tool"
    ],
